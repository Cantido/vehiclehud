...
% Here you will need to frame the project both within the particular subfield
% and within the larger framework of engineering as a whole. Assume your reader
% is a technical professional with little knowledge of electrical or computer
% engineering.  Students often struggle here wondering exactly how much detail
% or background information to include.  Try searching ieeexplore.org for
% professional research journal articles that interest you.  Read the
% introduction and literature summary portions of the papers. This will give 
% you some idea of what is needed in a technical introduction.  You need to
% write an introduction for your drafts so I can give you feedback.  

% It's possible for the entire team to collaborate on the writing of this, and
% other, sections.  While one person may do most of the wordsmithing, the
% entire team should be tasked with finding examples of similar work,
% determining what background content ought to be included, and helping to
% structure the entire section.

% This section should be 2-5 pages in length and should be at a high level.
% Leave the full technical details for later sections. This and the subsequent
% sections can include figures.  
...
The two main properties of HUDs--being focused at infinity and being
